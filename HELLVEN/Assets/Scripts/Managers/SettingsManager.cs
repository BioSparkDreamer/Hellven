...
public class SettingsManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //Adjust the value of the value texts to the right of the slider using the values stored in player prefs
        masterValueText.text = (masterSlider.value + 80).ToString("F0") + "%";
        musicValueText.text = (musicSlider.value + 80).ToString("F0") + "%";
        sfxValueText.text = (sfxSlider.value + 80).ToString("F0") + "%";
    }
